...
- [ ] El resto de las pantallas en escritorio (Vender, Ventas, Conversaciones, Caja, Agenda semanal, Inventario) — orden sugerido en la sección 8 de `AS_ADMIN_pantallas_y_escritorio_v1.md`
