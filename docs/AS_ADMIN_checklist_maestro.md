...
- [ ] El resto de las pantallas en escritorio (Caja, Agenda semanal/Jornadas del equipo, Inventario) — orden sugerido en la sección 8 de `AS_ADMIN_pantallas_y_escritorio_v1.md`
